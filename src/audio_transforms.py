...
from audioUtils import readFolder, mkdir, readFolderRecursive, load
...
def mixWithFolder(folder, transforms = []):
    ...
    def curriedMixWith(audio):
        ...
        #print('mix with', overlay)
        
        transformed_overlay = makeRandomTransforms(transforms, max_number_of_transforms, load(overlay)[0:len(audio)])
